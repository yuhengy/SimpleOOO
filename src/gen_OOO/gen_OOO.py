...
def gen_OOO(
  ...
  v += "          for (k=0; k<`ROB_SIZE; k=k+1) begin\n"
  v += "            if (ROB_state[k]==`STALLED && ROB_rs1_stall[k] &&\n"
  v += "                ROB_rs1_ROBlink[k]==i[`ROB_SIZE_LOG-1:0]) begin\n"
  v += "              ROB_rs1_stall[k] <= 1'b0;\n"
  v += "              ROB_rs1_data[k] <= ROB_rd_data[i];\n"
  v += "            end\n"
  v += "\n"
  v += "            if (ROB_state[k]==`STALLED && ROB_rs2_stall[k] &&\n"
  v += "                ROB_rs2_ROBlink[k]==i[`ROB_SIZE_LOG-1:0]) begin\n"
  v += "              ROB_rs2_stall[k] <= 1'b0;\n"
  v += "              ROB_rs2_data[k] <= ROB_rd_data[i];\n"
  v += "            end\n"
  v += "          end\n"
  v += "        end\n"
  v += "      end\n"
